                ...
                <div class="flex gap-3 items-center">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="text-xs text-white/60 flex items-center gap-2">
                      ...
                      <button type="button" data-name="${r.name}" data-city="${r.city}" class="phone-btn opacity-80 hover:opacity-100 transition" onclick="event.preventDefault(); event.stopPropagation(); const name=this.getAttribute('data-name'); const city=this.getAttribute('data-city'); window.open('https://www.google.com/search?q=' + encodeURIComponent(name + ' ' + city + ' telefon kontakt'), '_blank');" title="Najít telefon">
